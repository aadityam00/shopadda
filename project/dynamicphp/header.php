...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container-fluid">
            ...
            <!-- logo img  -->
            <div class="logo">
                <a class="navbar-brand" href="ShopADDA.php">
                    <img class="img-fluid" src="assest/imag/shopadda2.png" alt="Shop Adda Logo">
                </a>
            </div>
            <!-- search bar  -->
            ...
            <div class="collapse navbar-collapse nav-div d-lg-flex d-none" id="navbarNav">
                <ul class="navbar-nav nav_ul">
                    <!-- nav links  -->
                    <li class="nav-item ">
                        <a class="nav-link nav_list" href="ShopADDA.php">Home</a>
                    ...
                    <li class="nav-item me-3">
                        <a href="#">
                            <button class="btn btn-custom">Shop Now</button></a>
                    </li>
                </ul>
            </div>
            <!-- offcanvas nav  -->
            <div class="offcanvas offcanvas-end d-lg-none" tabindex="-1" id="offcanvasNav"
                ...
                <div class="offcanvas-header">
                    <h5 id="offcanvasNavLabel">Menu</h5>
                    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"></button>
                </div>
                <div class="offcanvas-body">
                    <ul class="navbar-nav">
                        <li class="nav-item"><a class="nav-link" href="ShopADDA.php">Home</a></li>
    ...
    <div class="search-container-2">
        ...
        <div class="input-group search-form-2">
            ...
            <input type="text" name="search" id="search-bar" placeholder="search for Products,brands and more"
